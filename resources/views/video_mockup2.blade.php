<x-guest-layout>
    <div class="flex flex-col">
        <iframe class="pt-8" width="1200" height="600" src="{{$url}}" title="YouTube video player" frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>


        <div class="border-b border-gray-200 p-5 m-5" style="width: 1200px;">
        ...
        <nav class="relative z-0 inline-flex shadow-sm rounded-md pt-5">
            ...
            <button type="button"
                    class="relative inline-flex items-center px-4 py-2 border border-gray-300 border-l-0 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500">
                Marcar com a llegit
            </button>
            <button type="button"
